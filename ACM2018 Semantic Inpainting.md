an LSTM framework is introduced to string all the subtaskes together. in this way, the essence learned from the previous subtasks are exploited to ease the learning of subsequent subtasks.
